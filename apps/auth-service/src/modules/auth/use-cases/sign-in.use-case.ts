...
// interface
import { ISignInDriverResponse } from '@app/common/interfaces/auth.interface';
// driver-proxy
import { DriverProxyService } from '@app/proxy/driver-proxy/driver-proxy.service';
// driver-refresh-token-proxy
...
export class SignInUseCase {
  ...
  async createDriverRefreshToken(driverId: string, refreshToken: string) {
    const driverRefreshTokenDocument =
      await this.driverProxyService.createDriverRefreshToken({
        driverId,
        token: refreshToken,
