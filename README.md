...
A sample project for learning clean architecture and project structure. **(NestJS, Typescript, Redis, MinIO, RabbitMQ and PostgreSQL, TypeORM)**
...
| **Config**                | Loads environment variables and application configuration (like Postgresql TypeORM, Redis, MinIO, etc.).                                                      |
